...
namespace org.csource.fastdfs
{
    ...
    {
        private TestAppender(ITestOutputHelper output)
        {
            ...
            try
            {
              ...
              storageServer = tracker.getStoreStorage(trackerServer);
                ...
                */
                ...
                Console.WriteLine("upload_appender_file time used: " + (DateTime.Now.Ticks - startTime) + " ms");
                ...
                */
                ...
                else
                {
                    ...
                    if (errno == 0)
                    {
                        Log.Error(client.get_file_info(group_name, appender_filename).ToString());
                    }
                    else
                    {
